document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            project1_desc: "Skill Swap is an innovative platform designed to empower Latin American women through the exchange of skills. It offers a unique solution to connect women with different skills and knowledge, facilitating an environment of collaboration and mutual growth. <u>Technologies Used:</u> Backend: Ruby on Rails, Frontend: HTML, CSS, Bootstrap, JavaScript, React.Base de datos: Active Record",
            ...
            project9_desc: "Vault Contract Vulnerability Audit and Remediation This repository contains a practical example of a security audit for an Ethereum smart contract, demonstrating a common vulnerability and its remediation. It includes the vulnerable, the remediated and secure versions, and an attack contract designed to exploit the original vulnerability.<u>Technologies Used:</u> Solidity, Hardhat, Ethers.js.",
            project10_title: "<strong>Simple Vault System</strong>",
            project10_desc: "Simple Vault System This repository contains an Ethereum smart contract that implements a basic vault system, allowing users to securely deposit and withdraw Ether (ETH). The contract has been designed with an emphasis on security, modularity (through inheritance), and transaction traceability.<u>Technologies Used:</u> Solidity, Hardhat, Ethers.js.",
            project11_title: "<strong>BlockchainMessenger</strong>",
            project11_desc: "The BlockchainMessenger contract is a simple contract that allows you to: <br> Store a message on the blockchain. <br> View the publicly stored message. <br> Allow only the person who created (deployed) the contract to update the message. <br> Count how many times the message has been updated. <br> This project is an introduction to basic smart contract concepts, such as state variables, the constructor, and functions with access restrictions.<u>Technologies Used:</u> Solidity, Hardhat, Ethers.js.",
            project12_title: "<strong>SHOPPING CART</strong>",
            project12_desc: "This project is an interactive shopping cart application, developed in React. It allows adding products to the cart, viewing the purchase summary, and proceeding to checkout. The cart buttons are reusable components that pass functions as props to handle the logic of adding and removing products, and the interface is updated in real-time.<u>Technologies Used:</u> React, CSS, JavaScript.",
            see_more_projects: "See more projects",
            // Technologies
            tech_ruby: "Ruby",
            tech_rails: "Ruby on Rails",            tech_nodejs: "Node.js",
            tech_nextjs: "Next.js",
