document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        es: {
            ...
            project11_desc: "El contrato BlockchainMessenger es un contrato simple que permite:\n    Almacenar un mensaje en la blockchain.\n    Ver el mensaje almacenado públicamente.\n    Permitir que solo la persona que creó (implementó) el contrato pueda actualizar el mensaje.\n    Contar cuántas veces se ha actualizado el mensaje.\n    Este proyecto es una introducción a los conceptos básicos de los contratos inteligentes, como variables de estado, el constructor y funciones con restricciones de acceso.. <u>Tecnologías Utilizadas:</u> Solidity, Hardhat, Ethers.js, React..",
